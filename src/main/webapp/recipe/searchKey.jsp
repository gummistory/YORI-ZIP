...
<body>
    ...
    <div class="search-bar">
       ...
       <div class="filter">
        <button data-category="모두보기" class="active">레시피</button>
        <button data-category="후식">디저트</button>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function loadRecipes() {
                $.ajax({
                    method: "GET",
                    url: `http://openapi.foodsafetykorea.go.kr/api/67f9fcdd1106497bb4f2/COOKRCP01/json/10/200`,
                })
                .done(function (res) {
